(()=>{
  ...
  function pageShell(){
    return `<section class="calendar-page family-fun-app-page">
        ...
        <div class="fun-feature-grid">
          ...
          <div class="fun-feature-card fun-feature-coming" aria-label="Family Games coming soon">
            ...
            <span class="fun-feature-copy">
              ...
              <small>Quizzes, challenges and games can live here next.</small>
            </span>
      ...
      <section class="fun-camera-feature-panel" id="funCameraFeature" hidden>
        <div class="fun-feature-topbar">
          <button class="fun-feature-back" type="button" data-family-fun-back><i data-lucide="arrow-left"></i> Family Fun</button>
          <div>
            <p class="eyebrow">FAMILY CAMERA</p>
            <h2>Family Camera</h2>
          </div>
        </div>

        <nav class="fun-main-tabs" aria-label="Family Camera sections">
        ...
        <div id="funCreatePanel">
          ...
          <section class="fun-mode-grid" aria-label="Family Camera modes">
          ...
          <section class="fun-result-card" id="funResult" hidden>
            <div class="fun-result-heading"><p class="eyebrow">YOUR CLIP</p><h2 id="funResultTitle">Family Camera clip</h2><p id="funResultMeta"></p></div>
        ...
        <section id="funGalleryPanel" hidden>
          <div class="fun-gallery-header">
            <div><p class="eyebrow">FAMILY CAMERA GALLERY</p><h2>Your family videos</h2><p>Videos shared here are visible to signed-in members of your family.</p></div>
          ...
          <div class="fun-gallery-empty" id="funGalleryEmpty">
            <span>📹</span>
            <strong>No Family Camera videos yet</strong>
            <p>Create a clip and tap <b>Add to Gallery</b>. It will automatically appear under the correct heading.</p>
            <button class="primary" type="button" data-fun-tab="create">Open Family Camera</button>
          </div>
      ...
      <p class="fun-privacy-note">Family Camera videos are stored privately in Family Book cloud storage. Only signed-in members of your family can view them.</p>
    </section>`;
  }
  ...
  function bindRoute(){
    ...
    script.src="js/family-fun-studio.js?v=app-route-2";
    script.dataset.familyFunRuntime="1";
    script.onload=()=>window.icons?.();
    script.onerror=()=>console.error("Could not load Family Camera.");
