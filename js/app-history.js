...
fbLoadScript('js/full-tree-polish.js?v=5','full-tree-polish-script');
...
fbLoadScript('js/mobile-profile-menu-navigation.js?v=2','mobile-profile-menu-navigation-script');
